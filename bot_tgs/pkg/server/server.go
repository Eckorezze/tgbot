...
func NewAuthorizationServer(pocketClient *pocket.Client, tokenRepository repos.TokenRepository, redirectURL string) *AuthorizationServer {
...
func (s *AuthorizationServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	requestToken, err := s.tokenRepository.Get(chatID, repos.RequestToken)
	if err != nil {
	...
	err = s.tokenRepository.Save(chatID, authResp.AccessToken, repos.AccessTokens)
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
